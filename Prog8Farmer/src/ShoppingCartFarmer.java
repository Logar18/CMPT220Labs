 ...
 * This is the class containing the shopping cart, which is in charge of storing and keeping track of an
 * array of up to 10 objects.
 */
public class ShoppingCartFarmer 
{
	 ...
	 */
	public ItemFarmer findMostExpensive()
	{
		int maxItem = 0;
